...
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT * FROM tempat_umum WHERE id='$id'");
...
if(isset($_POST['submit'])) {
    ...
    $query = mysqli_query($koneksi, "UPDATE tempat_umum SET 
                                    nama='$nama', 
                                    alamat='$alamat', 
                                    jenis='$jenis', 
                                    latitude='$latitude', 
                ...
                <div class="card shadow-sm border-0 rounded-lg">
                    <div class="card-header bg-primary bg-gradient text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="mb-0">
                                <i class="fas fa-building me-2"></i> Edit Tempat Umum
                            </h4>
                        ...
                        <form method="post" class="needs-validation" novalidate>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="jenis" class="form-select" required>
                                    ...
                                    <option value="Taman" <?php if($data['jenis']=='Taman') echo 'selected'; ?>>Taman</option>
                                    <option value="Pasar" <?php if($data['jenis']=='Pasar') echo 'selected'; ?>>Pasar</option>
                                    <option value="Terminal" <?php if($data['jenis']=='Terminal') echo 'selected'; ?>>Terminal</option>
                                    <option value="Kantor Pemerintah" <?php if($data['jenis']=='Kantor Pemerintah') echo 'selected'; ?>>Kantor Pemerintah</option>
                                    <option value="Lainnya" <?php if($data['jenis']=='Lainnya') echo 'selected'; ?>>Lainnya</option>
                                </select>
                                <div class="invalid-feedback">
                                    Jenis tempat harus dipilih
                                </div>
                            </div>
                            <div class="row">
