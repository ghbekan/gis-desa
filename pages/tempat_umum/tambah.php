...
if(isset($_POST['submit'])) {
    ...
    $query = mysqli_query($koneksi, "INSERT INTO tempat_umum (nama, alamat, jenis, latitude, longitude) 
...
<html>
<head>
    <title>Tambah Tempat Umum</title>
                ...
                <div class="card shadow-sm border-0 rounded-lg">
                    <div class="card-header bg-primary bg-gradient text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="mb-0">
                                <i class="fas fa-building me-2"></i> Tambah Tempat Umum
                            </h4>
