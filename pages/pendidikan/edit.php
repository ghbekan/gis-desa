...
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT * FROM pendidikan WHERE id='$id'");
...
if(isset($_POST['submit'])) {
    ...
    $query = mysqli_query($koneksi, "UPDATE pendidikan SET 
                                    nama='$nama', 
                                    alamat='$alamat', 
                                    jenjang='$jenjang', 
                                    latitude='$latitude', 
...
<html>
<head>
    <title>Edit Lembaga Pendidikan</title>
                ...
                <div class="card shadow-sm border-0 rounded-lg">
                    <div class="card-header bg-primary bg-gradient text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="mb-0">
                                <i class="fas fa-school me-2"></i> Edit Lembaga Pendidikan
                            </h4>
                        ...
                        <form method="post" class="needs-validation" novalidate>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="jenjang" class="form-select" required>
                                    ...
                                    <option value="TK" <?php if($data['jenjang']=='TK') echo 'selected'; ?>>TK</option>
                                    <option value="SD" <?php if($data['jenjang']=='SD') echo 'selected'; ?>>SD</option>
                                    <option value="SMP" <?php if($data['jenjang']=='SMP') echo 'selected'; ?>>SMP</option>
                                    <option value="SMA" <?php if($data['jenjang']=='SMA') echo 'selected'; ?>>SMA</option>
                                    <option value="Perguruan Tinggi" <?php if($data['jenjang']=='Perguruan Tinggi') echo 'selected'; ?>>Perguruan Tinggi</option>
                                </select>
                                <div class="invalid-feedback">
